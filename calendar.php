        ...
        <div id="container">
            ...
            <main>
                <section id="labels" class="highlight">
                    <h2>Calendar</h2>
                    <span class="hw">Homework</span><span class="assignment">Assignment</span><span class="workshop">Workshop</span>
                </section>
                <!--
                    Add blurry story.
                ...
                <section>
                    ...
                    <ul class="next-week">
                        <li class="assignment">Fill out your HTML profile's we started in class (<a href="./assignments.php#1">Assignment 1</a>).<li>
                    </ul>
                ...
                <section>
                    ...
                    <ul class="next-week">
                        <li class="workshop">Coding from Life workshop</li>
